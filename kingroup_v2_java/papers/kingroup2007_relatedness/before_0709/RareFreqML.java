 ...
 * User: jc138691, Date: 18/09/2006, Time: 14:36:04
 */
public class RareFreqML extends RareFreqKinship
{
...
//    GROUP_SIZE = 100;
////    MIN_PROP = 10;
//    calcByProportion("_ML_TRI_NL" + N_LOCI + "_GS" + GROUP_SIZE  +"_NA" + N_ALLELES);
//  }
...
//  }
  ...
  public void testAllSingleFamily_forML(int nTrials) {
    ...
    R_MTRX_TYPE = Kingroup.PAIRWISE_R_KINSHIP_ML;
    N_TRIALS = nTrials;
    calcByProportion("_ML_TR_NL" + N_LOCI + "_GS" + GROUP_SIZE  + "_NA" + N_ALLELES);
  }
}
