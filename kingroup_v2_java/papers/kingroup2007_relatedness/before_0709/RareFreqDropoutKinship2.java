 ...
 * User: jc138691, Date: 21/09/2006, Time: 08:44:26
 */
public class RareFreqDropoutKinship2 extends RareFreqKinship
{
  public void testSingleFamilyV2() {
    ...
    GROUP_SIZE = 100;
//    MIN_PROP = 10;
    calcByProportion("_QG2_TRI_DROPOUT_NL" + N_LOCI + "_NA" + N_ALLELES);
  }
