 ...
 * User: jc138691, Date: 18/09/2006, Time: 14:36:32
 */
public class RareFreqLynch extends RareFreqKinship
{
  public void testByNL() {
    R_MTRX_TYPE = Kingroup.PAIRWISE_R_LR;
    N_ALLELES = 20;
    MIN_N_LOCI = 2;
    MAX_N_LOCI = 10;
    ...
    GROUP_SIZE = 9;
    N_GROUPS = 3;
    calcByNL("_LR_RND_NA" + N_ALLELES + "_FGS" + GROUP_SIZE + "_NG" + N_GROUPS);
  }
  public void testByNA() {
    calcByNA("_LR_TRI_NL" + N_LOCI + "_FGS" + GROUP_SIZE + "_NG" + N_GROUPS);
  }
  public void testDeirkes() {
    ...
    calcByNG("_LR_DEI_NL" + N_LOCI + "_FGS" + GROUP_SIZE);
  }
  public void testByNG() {
    N_ALLELES = 10;
    N_LOCI = 10;
    calcByNG("_LR_TRI_NL" + N_LOCI + "_FGS" + GROUP_SIZE + "_NA" + N_ALLELES);
  }
...
//    GROUP_SIZE = 100;
////    MIN_PROP = 10;
//    calcByProportion("_LR_TRI_NL" + N_LOCI + "_GS" + GROUP_SIZE + "_NA" + N_ALLELES);
//  }
  public void testSingleFamilyV3(int nTrials) {
    ...
    MAX_PROP = 80;
    PROP_STEP = 10;
    calcByProportion("_LR_EQ_NL" + N_LOCI + "_GS" + GROUP_SIZE  + "_NA" + N_ALLELES);
  }
  public void testAllSingleFamily_forML(int nTrials) {
    setupAllSingleFamily_forML();
    R_MTRX_TYPE = Kingroup.PAIRWISE_R_LR;
    N_TRIALS = nTrials;
    calcByProportion("_LR_TR_NL" + N_LOCI + "_GS" + GROUP_SIZE  + "_NA" + N_ALLELES);
  }
  ...
  public void testSingleFamilyV3_bySize(int nTrials) {
    ...
    MAX_PROP = 150;
    PROP_STEP = 10;
    calcByProportion("_LR_EQ_NL" + N_LOCI + "_NFS" + GROUP_SIZE  + "_NA" + N_ALLELES);
  }
}
