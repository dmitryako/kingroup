 ...
 * User: jc138691, Date: 19/04/2005, Time: 12:43:20
 */
public class BSplBoundBasis extends BSplineBasis {
  public static int NUM_MISSING_HEAD = 1;
  public static int NUM_MISSING_TAIL = 2;
  public static int NUM_MISSING = 3;
  public BSplBoundBasis(valarray x, valarray t, int k) {
    super(x, t, k);
    loadBSplineArr();
