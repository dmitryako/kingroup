 ...
 * User: jc138691, Date: 21/09/2006, Time: 08:50:54
 */
public class RareFreqDropoutLynch extends RareFreqKinship
{
...
//    N_TRIALS = 1000;  // 10,000 paper
    ...
    GROUP_SIZE = 50;
//    MIN_PROP = 10;
    calcByProportion("_LR_TRI_DROPOUT_NL" + N_LOCI + "_GS" + GROUP_SIZE + "_NA" + N_ALLELES);
  }
...
//    log.info("observedFreq=\n" + observedFreq);
    ...
    RMtrx_LR mtrx = new RMtrx_LR(sysPop);
    mtrx.calc();
