 ...
 * User: jc138691, Date: 26/09/2006, Time: 16:33:04
 */
public class RareFreqDropoutKinshipTrue   extends RareFreqKinship
{
...
//    N_TRIALS = 1000;  // 10,000 paper
    ...
    GROUP_SIZE = 50;
//    MIN_PROP = 10;
    calcByProportion("_QG_TRUE_TRI_DROPOUT_NL" + N_LOCI + "_GS" + GROUP_SIZE + "_NA" + N_ALLELES);
  }
