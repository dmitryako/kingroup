 ...
 * User: jc138691, Date: 21/09/2006, Time: 08:48:18
 */
public class RareFreqDropoutKinship  extends RareFreqKinship
{
  public void testAllSingleFamily() {
    testSingleFamilyV2();
    new RareFreqDropoutKinshipTrue().testSingleFamilyV2();
    new RareFreqDropoutHegKon().testSingleFamilyV2();
    new RareFreqDropoutLynch().testSingleFamilyV2();
    new RareFreqDropoutWang().testSingleFamilyV2();
  }
...
//    N_TRIALS = 1000;  // 10,000 paper
    ...
    GROUP_SIZE = 50;
//    MIN_PROP = 10;
    calcByProportion("_QG_TRI_DROPOUT_NL" + N_LOCI + "_GS" + GROUP_SIZE + "_NA" + N_ALLELES);
  }
...
//    log.info("observedFreq=\n" + observedFreq);
    ...
    PairwiseRMtrx mtrx = new PairwiseRMtrx(sysPop);
    mtrx.calc();
